...
from Bestie_Robot.__main__ import STATS, TOKEN, USER_INFO
import Bestie_Robot.modules.sql.userinfo_sql as sql
...
from Bestie_Robot.modules.sql.afk_redis import is_user_afk, afk_reason
from Bestie_Robot.modules.sql.users_sql import get_user_num_chats
...
from Bestie_Robot import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/MaddieTheRock/556939">?</a>]'.format(bot.username)
    ...
    if INFOPIC:
        try:
            profile = context.bot.get_file(
                context.bot.get_user_profile_photos(user.id).photos[0][-1]["file_id"]
            )
